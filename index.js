...
const UUID = process.env.UUID || '608173d2-ed8e-4cc4-babb-39dad003c407'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'NwxKJwM9UKRCX5TBPaBm0IrjNCSyflif';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
