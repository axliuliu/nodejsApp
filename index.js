...
const UUID = process.env.UUID || '0ea55c39-0282-4654-a1cf-e2fdcd220fa9'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'VHTEk5wXIwqMobTFE7wtJYy88ZtIRops';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'bailangjjyy-axx.hf.space';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
